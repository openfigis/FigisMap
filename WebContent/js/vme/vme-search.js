...
VMEData.stores.rfmoStore.on('load',function(store, records, options){
    ...
    store.each(function(records,count,tot) {
        ...
        var radio = column.add({
            ...
            boxLabel: '<a id="infoRFBimage_'+records.data.id+'_RFB'+'" style="color:#000000"><img style="margin-bottom: 1px; vertical-align: bottom" title = "Clik To View Regional Measures" src="assets/vme/img/icons/information.png">'+records.data.acronym+'</a>',
            name: 'rfb',
                ...
                afterrender: function(radio){               
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function(response) {
                                ...
                                Ext.get(id).dom.lastChild.parentNode.outerHTML = '<a id="'+id+'" style="color:#000000" href="javascript:void(0);" //onClick="VMEInfo.infoHandler(\''+json.resultList[0].factsheetUrl+'\',true);"><img style="margin-bottom: 1px; vertical-align: bottom" title = "Clik To View Regional Measures" src="assets/vme/img/icons/information.png"></a><span>'+radio.acronym+'</span>';
                        }
                    });
